...
const quantity = async (e)=>{
    ...
    console.log('quantity res:', res);
    console.log('quantity product_original_price:', product_original_price);
    console.log('quantity product_price:', product_price);
    ...
    console.log('quantity span_quantity:', span_quantity.innerHTML);
    console.log('quantity price_discount:', price_discount.innerHTML);
    console.log('quantity price_original:', price_original.innerHTML);
    // Swal.fire({
    //     position: "top-end",
